...
#### 📌 Quarta (03/07) — **Página Inicial + Busca**
- Criar página `/` com:
    - Campo de busca
...
#### 📌 Quinta (04/07) — **Login, Cadastro e Estado do Usuário**
...
#### 📌 Sábado (06/07) — **Formulário de Criação/Edição**
...
#### 📌 Domingo (07/07) — **🧪 Revisão e Ajustes**
- Testar cada página
...
#### 📌 Segunda (08/07) — **Setup do Backend + Docker + Prisma**
...
#### 📌 Terça (09/07) — **Listagem Pública de experiencias**
...
#### 📌 Quarta (10/07) — **CRUD Básico de experiencias (sem login)**
- Rotas:
    - `GET /experiencias`
    - `POST /experiencias`
    - `PUT /experiencias/:id`
...
#### 📌 Quinta (11/07) — **Interações: Curtidas e Favoritos**
...
#### 📌 Sexta (12/07) — **CRUD de Usuários (simples)**
- Módulo `usuarios`
- Rotas:
    - `GET /usuarios`
    - `POST /usuarios`
...
#### 📌 Sábado (13/07) — **Refino e Documentação**
...
#### 📌 Segunda (15/07) — **Configuração de Consumo da API**
...
#### 📌 Terça (16/07) — **Integração da Página Inicial**
...
#### 📌 Quarta (17/07) — **Integração de Curtidas e Favoritos**
...
#### 📌 Quinta (18/07) — **Minhas experiencias e Favoritas**
...
#### 📌 Sexta (19/07) — **Criação e Edição de Experiencia**
...
#### 📌 Sábado (20/07) — **Exclusão e UX Final**
...
#### 📌 Domingo (21/07) — **🧪 Revisão e Testes**
...
#### 📌 Segunda (22/07) — **Preparação para Produção**
...
#### 📌 Terça (23/07) — **Docker Compose Final**
...
#### 📌 Quarta (24/07) — **Configuração do Nginx**
- Criar `nginx.conf`:
...
#### 📌 Quinta (25/07) — **Ajustes Finais na UX/UI**
...
#### 📌 Sábado (27/07) — **Revisão Técnica Geral**
...
#### 📌 Domingo (28/07) — **Resumir tudo que aprendi**
