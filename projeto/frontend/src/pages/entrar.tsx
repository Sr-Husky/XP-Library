...
function Entrar(){
    ...
    function login(){
        ...
        if(!validaEmail()) {setMsg("Digite um email válido"); setEmailRed(true); valido=false;}
            ...
            if(valido) console.log("Usuário logado");
        }
    }
        ...
        if(selecao === '') return (<p className="text-white text-[2.5vw] md:text-[1.5vw] lg:text-[1vw]">Faça login ou cadastre-se escolhendo um card</p>);
            ...
            return (
                <div className='flex flex-col items-center justify-center gap-[1vw] md:gap-[0.5vw]'>
                    ...
                    <EditBox onFocus={() => resetStyle()} rotulo='Digite seu email' value={email} onChange={setEmail} onEnter={handleEnterPress} style={`max-w-[600px] w-[70vw] h-[8vw] md:w-[60vw] md:h-[6vw] lg:w-[28vw] lg:h-[4vw] xl:w-[30vw] xl:h-[3vw] ${emailRed && "border-[3px] border-[rgb(255,30,30)]"}`} styleInput={`text-[3vw] md:text-[1.5vw] lg:text-[1vw] ${emailRed && "text-[rgb(255,100,100)] placeholder:text-[rgb(255,100,100)]"}`} />
                    <EditBox onFocus={() => resetStyle()} rotulo='Digite sua senha' value={senha} onChange={setSenha} onEnter={handleEnterPress} style={`max-w-[600px] w-[70vw] h-[8vw] md:w-[60vw] md:h-[6vw] lg:w-[28vw] lg:h-[4vw] xl:w-[30vw] xl:h-[3vw] ${senhaRed && "border-[3px] border-[rgb(255,30,30)]"}`} styleInput={`text-[3vw] md:text-[1.5vw] lg:text-[1vw] ${senhaRed && "text-[rgb(255,100,100)] placeholder:text-[rgb(255,100,100)]"}`} />
                    <Botao texto='Entrar' onClick={login} style='w-[16vw] h-[8vw] md:w-[10vw] md:h-[4vw]' styleTexto='text-[2vw] md:text-[1vw]' />
                    {msg && <p className='text-[1.5vw] md:text-[0.8vw] text-white bg-[rgb(255,30,30)] rounded-full px-[1vw] p-[0.3vw] mb-[-3vw] mt-[0.7vw]'>{msg}</p>}
                </div>
            )
        } else {
            return (
                <div>
                    <div className='flex flex-col items-center justify-center gap-[1vw] md:gap-[0.5vw]'>
                        ...
                        <EditBox onFocus={() => resetStyle()} rotulo='Digite seu nome de usuário' value={usuario} onChange={setUsuario} onEnter={handleEnterPress} style={`max-w-[600px] w-[70vw] h-[8vw] md:w-[60vw] md:h-[6vw] lg:w-[28vw] lg:h-[4vw] xl:w-[30vw] xl:h-[3vw] ${usuarioRed && "border-[3px] border-[rgb(255,30,30)]"}`} styleInput={`text-[3vw] md:text-[1.5vw] lg:text-[1vw] ${usuarioRed && "text-[rgb(255,100,100)] placeholder:text-[rgb(255,100,100)]"}`} />
                        <EditBox onFocus={() => resetStyle()} rotulo='Digite seu email' value={email} onChange={setEmail} onEnter={handleEnterPress} style={`max-w-[600px] w-[70vw] h-[8vw] md:w-[60vw] md:h-[6vw] lg:w-[28vw] lg:h-[4vw] xl:w-[30vw] xl:h-[3vw] ${emailRed && "border-[3px] border-[rgb(255,30,30)]"}`} styleInput={`text-[3vw] md:text-[1.5vw] lg:text-[1vw] ${emailRed && "text-[rgb(255,100,100)] placeholder:text-[rgb(255,100,100)]"}`} />
                        <EditBox onFocus={() => resetStyle()} rotulo='Digite sua senha' value={senha} onChange={setSenha} onEnter={handleEnterPress} style={`max-w-[600px] w-[70vw] h-[8vw] md:w-[60vw] md:h-[6vw] lg:w-[28vw] lg:h-[4vw] xl:w-[30vw] xl:h-[3vw] ${senhaRed && "border-[3px] border-[rgb(255,30,30)]"}`} styleInput={`text-[3vw] md:text-[1.5vw] lg:text-[1vw] ${senhaRed && "text-[rgb(255,100,100)] placeholder:text-[rgb(255,100,100)]"}`} />
                        <Botao texto='Entrar' onClick={cadastro} style='w-[16vw] h-[8vw] md:w-[10vw] md:h-[4vw]' styleTexto='text-[2vw] md:text-[1vw]' />
                        {msg && <p className={`text-[1.5vw] md:text-[0.8vw] text-white bg-[rgb(255,30,30)] rounded-full px-[1vw] p-[0.3vw] mb-[-3vw] mt-[0.7vw] ${!(usuarioRed || emailRed || senhaRed) && "bg-[rgb(30,255,30)] text-[rgb(0,0,0)]"}`}>{msg}</p>}
                    </div>
                </div>
            )
        }
        ...
        <div className={`mt-[8vh]`}>
            {size.width >= 1200 ?
                <div className="flex w-full justify-center p-4">
                    <div onClick={() => {resetStyle(); (selecao === 'cadastro' || selecao === '') ? setSelecao('login') : setSelecao('');}} className={`flex items-center mr-[3.5vw] transition-all ${selecao === 'login' && "ml-[3.5vw] mr-[0vw]"}`}>
                    ...
                    <div className={`flex justify-center items-center max-w-[700px] w-[40vw] h-[25vw] bg-[rgb(60,60,60)] rounded-[5vw] mx-[-0.5vw] ${(onHoverCard || selecao !== '') && "border border-white"}`}>
                        {campo()}
                    </div>
                    <div onClick={() => {resetStyle();(selecao === 'login' || selecao === '') ? setSelecao('cadastro') : setSelecao('');}} className={`flex items-center ml-[3.5vw] transition-all ${selecao === 'cadastro' && "mr-[3.5vw] ml-[0vw]"}`}>
                ...
                <div className="flex flex-wrap w-full justify-center p-4">
                    ...
                    <div onClick={() => {resetStyle(); (selecao === 'cadastro' || selecao === '') ? setSelecao('login') : setSelecao('');}} className={`flex mt-[2vw] items-center transition-all ${selecao === 'login' && "mt-[0vw] mb-[3vw]"}`}>
                    ...
                    <div onClick={() => {resetStyle(); (selecao === 'login' || selecao === '') ? setSelecao('cadastro') : setSelecao('');}} className={`flex mt-[2vw] items-center transition-all ${selecao === 'cadastro' && "mt-[0vw] mb-[3vw]"}`}>
